...
public class Calculator implements ActionListener{
	...
	public Calculator(){
        jf=new JFrame("Moiz's Calculator");
        jf.setBounds(0, 0, 500, 550);
        jf.setLayout(null);
        jf.getContentPane().setBackground(Color.BLACK);
		
		DisplayLabel=new JLabel("Write Here......");
        DisplayLabel.setBounds(20, 40, 340, 90);
        ...
        DisplayLabel.setBounds(20, 40, 440, 90);
        DisplayLabel.setBackground(Color.lightGray);
        DisplayLabel.setOpaque(true);
        DisplayLabel.setHorizontalAlignment(SwingConstants.RIGHT);
        DisplayLabel.setForeground(Color.BLACK);
        ...
        equelbutton.setBackground(Color.yellow);
